    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        //position
                        .requestMatchers(HttpMethod.GET, "/professional/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/professional/list").permitAll()//.hasAnyRole("USER", "ADMIN")
                        ...
                        //professions
                        .requestMatchers(HttpMethod.POST, "/availableHours/register").permitAll()
                        .requestMatchers(HttpMethod.GET, "/availableHours/list").permitAll()//.hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/availableHours/search").permitAll()//.hasAnyRole("USER", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/procedureSubCategory/register").permitAll()
                        .requestMatchers(HttpMethod.GET, "/procedureSubCategory/list").permitAll()//.hasAnyRole("USER", "ADMIN")
